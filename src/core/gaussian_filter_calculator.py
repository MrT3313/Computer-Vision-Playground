class GaussianFilterCalculator:
    ...
    def calculate(self, constant: float) -> dict:
        ...
        for idx, (row, col) in enumerate(affected_cells):
            ...
            # Get the Gaussian kernel weight at this position
            ...
            calculations.append({
                ...
                'kernel_value': kernel_value,  # Base Gaussian kernel weight
        ...
        # For Gaussian filter, output is the sum (kernel weights are pre-normalized)
        ...
        return {
            ...
            'output': final_output,  # Final output value (sum of weighted values)
